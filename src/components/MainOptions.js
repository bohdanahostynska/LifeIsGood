  ...
  return (
    <div className="main_options">
      <div className="main_options_item">
        <img className="main_options_pic" src={All} alt="all" />
        <h4 className="options_title">All</h4>
      </div>
      <div className="main_options_item">
        <img className="main_options_pic" src={Burger} alt="all" />
        <h4 className="options_title">Burger</h4>
      </div>
      <div className="main_options_item">
        <img className="main_options_pic" src={Pizza} alt="all" />
        <h4 className="options_title">Pizza</h4>
      </div>
      <div className="main_options_item">
        <img className="main_options_pic" src={Salads} alt="all" />
        <h4 className="options_title">Salads</h4>
      </div>
      <div className="main_options_item">
        <img className="main_options_pic" src={Donut} alt="all" />
        <h4 className="options_title">Donut</h4>
      </div>
      <div className="main_options_item">
        <img className="main_options_pic" src={Drinks} alt="all" />
